  ...
  render() {
    ...
    return (
      <div className="m-1 card" style={{ width: '25rem' }}>
        ...
        <Button type="button" className="btn btn-success m-1" onClick={() => this.props.modalShow()} >Log Past Trip</Button>
        <Button type="button" className="btn btn-warning m-1" onClick={() => this.props.modalShow()}>Plan New Trip</Button>
      </div>
    )
  }
}
