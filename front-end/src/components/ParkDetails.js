  ...
  return (
    <div className="container">
      ...
      <div className="pt-4 text-dark">
        ...
        <Button type="button" className="btn btn-success m-1 float-right" >Log Past Trip</Button>
        <Button type="button" className="btn btn-warning m-1 float-right" >Plan New Trip</Button>
      </div >
    </div >
  )
}
